...
import { PlayCircle, CheckCircle, Clock, Users, BarChart2, BookOpen, Star, ChevronDown, ChevronRight, ArrowUp, X } from 'lucide-react';
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="flex flex-wrap items-center gap-6 text-sm text-gray-300">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span>{lessons.length || course.lessons || 0} Lessons</span>
                </div>
              </div>
            </div>
