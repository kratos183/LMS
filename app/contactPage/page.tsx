            ...
            <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <input 
                  type="text" 
                  placeholder="Name*" 
                  className="w-full border border-gray-200 rounded-lg p-3 text-sm focus:outline-none focus:border-orange-500 transition" 
                  required
                />
                <input 
                  type="email" 
              ...
              <div className="flex items-center gap-2">
                <input type="checkbox" id="save-info" className="rounded text-orange-500 focus:ring-orange-500 h-4 w-4" />
                <label htmlFor="save-info" className="text-xs text-gray-500 cursor-pointer">
              ...
              <button 
                type="submit" 
                className="bg-orange-500 hover:bg-orange-600 text-white font-medium px-8 py-3 rounded-full text-sm transition shadow-md shadow-orange-100"
              >
                Posts Comment
              </button>
            </form>
